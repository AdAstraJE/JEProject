...
#pragma mark -
- (void)lookArm{
    JELiteTV *_ = [JELiteTV F:self.tvFrame style:(UITableViewStylePlain) cellC:UITableViewCell.class cellH:50 cell:^(__kindof UITableViewCell *cell, UITableView *tv, NSIndexPath *idx, H3ArmModel *obj) {
        cell.textLabel.text = obj.name;
        
    } select:nil].addTo(self.view);
...
#pragma mark -
- (void)lookHero{
    JELiteTV *_ = [JELiteTV F:self.tvFrame style:UITableViewStyleGrouped cellC:UITableViewCell.class cellH:50 cell:^(__kindof UITableViewCell *cell, UITableView *tv, NSIndexPath *idx, H3HeroModel *obj) {
