...
//    [menu setTargetRect:self.frame inView:self.superview];
     [menu setTargetRect:CGRectMake(self.frame.origin.x, self.frame.origin.y + self.frame.size.height/2 , self.frame.size.width, self.frame.size.height) inView:self.superview];
