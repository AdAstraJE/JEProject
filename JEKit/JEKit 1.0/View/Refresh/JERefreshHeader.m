...
- (UIImageView *)arrowView{
    if (!_arrowView) {
        ...
        UIImage *image = [UIImage imageNamed:JEResource(@"JERefresharrow")];
...
- (void)setColor:(UIColor *)color{
    _color = color;
    _arrowView.image = [UIImage imageNamed:JEResource(@"JERefresharrow")].color(_color);
}
...
- (void)scrollViewContentOffsetDidChange:(NSDictionary *)change{
    ...
    shapeLayer.strokeColor = _color ? _color.CGColor : [UIColor lightGrayColor].CGColor;
