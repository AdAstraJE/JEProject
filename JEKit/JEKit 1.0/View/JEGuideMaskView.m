...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    UIImage *arrow = [UIImage imageNamed:[@"JEResource.bundle" stringByAppendingPathComponent:@"png_je_guide_arrow"]];
    if (arrow == nil) { [UIImage imageNamed:@"png_je_guide_arrow"];}
