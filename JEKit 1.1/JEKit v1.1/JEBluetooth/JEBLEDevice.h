...
typedef void (^BLE_didWriteValueBlock)(NSError *error);///< 写入完成的回调
typedef void (^BLE_readNotifyBlock)(CBCharacteristic *crt,NSError *error);///< 读取通知回调 
...
- (NSMutableArray <JEBLECommand *> *)allCmds;///< 获取当前指令队列情况
- (JEBLECommand *)currentCmd;///< 当前操作指令
